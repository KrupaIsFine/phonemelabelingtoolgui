...
class MyMainWindow(QMainWindow):
    def __init__(self):
        ...
        self.plot_widget2 = pg.PlotWidget(background='w')  # Set a white background
        # Set contents margins to zero
    ...
    def plot_graph(self, path):
        ...
        img = pg.ImageItem()
        img.setImage(Sxx)
        # img.setLookupTable(pg.colorMap('viridis'))  # Set colormap to 'viridis'
        self.plot_widget2.addItem(img)
    ...
    def resizeEvent(self, event):
        ...
        new_size = event.size()
        self.plot_widget.setGeometry(0, 0, new_size.width(), 450)
        self.plot_widget2.setGeometry(0, 0, new_size.width(), 450)
        event.accept()
